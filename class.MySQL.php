...
class MySQL {
	...
	// Base variables
	static $lastError;	 // Holds the last error
	static $lastQuery;	 // Holds the last query
	static $result;	  // Holds the MySQL query result
	static $records;	  // Holds the total number of records returned
	static $affected;	 // Holds the total number of records affected
	static $rawResults;	// Holds raw 'arrayed' results
	static $arrayedResult;   // Holds an array of the result
	static $hostname; // MySQL Hostname
	static $username; // MySQL Username
	static $password; // MySQL Password
	static $database; // MySQL Database
	static $databaseLink;  // Database Connection Link
	...
	function ExecuteSQL($query) {
		...
		if (self::$result = mysql_query($query, self::$databaseLink)) {
			...
			self::$lastError = mysql_error($this->databaseLink);
			return false;
		}
	}
