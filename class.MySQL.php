...
//        }
    ...
    private function Connect($persistant = false)
    {
        ...
        mysql_query("set character set 'utf8'", $this->databaseLink);
        mysql_query("SET NANES 'utf8'", $this->databaseLink);
    ...
    /**
     * @param $query
     * @return bool true:no result   else: array result
     */
    function ExecuteSQLOneResult($query){
        $result = $this->ExecuteSQL($query);
        //if exist，return first row as array
        if($this->records > 0){
            $result = $result[0];
        }
        return $result;
